 ...
 *
 * Bron: /public/brand/ZZP-Schakel-header-wit.png (1385×453, transparant,
 * afgeleid van het aangeleverde logobestand met een schone, harde rand).
 * Daarvan zijn exacte verkleiningen gemaakt op 160/320/480 px (1x/2x/3x)
 * zodat de letters scherp blijven; de browser kiest per schermdichtheid.
 * Altijd op verhouding, nooit bijgesneden, opnieuw getekend of anders gekleurd.
 */
