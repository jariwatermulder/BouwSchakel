# ZZP Schakel — Juridische Overwegingen
...
ZZP Schakel presenteert zich en gedraagt zich als **bemiddelingsplatform**: het brengt opdrachtgevers en zelfstandige zzp'ers bij elkaar en faciliteert contact en administratie. De **overeenkomst van opdracht** komt tot stand tussen opdrachtgever en ZZP'er; ZZP Schakel is daarbij geen partij.

Productbeslissingen bewaken bewust het onderscheid tussen:

- **Bemiddeling** — partijen vinden en contact leggen; ZZP Schakel stuurt de arbeid niet aan.
- **Tussenkomst** — ZZP Schakel wordt contractueel/financieel tussenschakel (risicovoller; vermijden tenzij bewust gekozen en juridisch ingericht).
- **Terbeschikkingstelling van arbeid** — leiding/toezicht/allocatie door ZZP Schakel (uitzenden/uitlenen). Dit **vermijden**; het raakt Waadi en registratie-/vergunningsplichten.

**Ontwerpimplicaties:**

- ZZP Schakel bepaalt niet wie waar werkt, geeft geen werkinstructies, en oefent geen leiding/toezicht uit.
...
Relevant zodra er sprake zou zijn van terbeschikkingstelling. Zolang ZZP Schakel strikt bemiddelt (geen leiding/toezicht, geen allocatie), is de positie anders. Bij twijfel of bij toevoeging van tussenkomst-/detacheringsfuncties: juridisch toetsen (o.a. registratie-/informatieverplichtingen).

## 4. Toekomstige regelgeving (o.a. Wtta — toelating terbeschikkingstelling arbeidskrachten)

Aankomende regelgeving rond het ter beschikking stellen van arbeidskrachten kan relevant worden **indien** ZZP Schakel richting uitlenen/detacheren zou bewegen. De architectuur houdt hiermee rekening door bemiddeling en eventuele tussenkomst/terbeschikkingstelling **strikt gescheiden** te modelleren, zodat later per module compliance kan worden ingericht. Concrete verplichtingen: juridisch laten toetsen op het moment dat zo'n functie wordt overwogen.
...
- ZZP Schakel is bemiddelaar en niet verantwoordelijk voor de kwaliteit/uitvoering van het werk of voor geschillen tussen partijen.
